...
async def console(client):
    ...
    print((Fore.GREEN + Style.BRIGHT) + "-----[Connected Servers] " + str(len(client.guilds)))
    print("-----[Total Users] " + str(len(client.users))) 
    print("-----[Log Errors] " + str(get_value('logging')))
    print("-----[Bot Prefix] " + str(get_value('prefix')))
    print("-----[Bot ID] " + str(client.user.id))
    print("-----[Bot Name] " + str(client.user.name))
    print((Fore.MAGENTA + Style.BRIGHT) + "\n[COMMANDS]: Menu, Shutdown, Reload.")
    ch = str(await ainput("[CONSOLE] Enter Command To Execute: ")).lower()
    if ch == 'menu':
